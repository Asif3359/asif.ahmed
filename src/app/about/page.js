...
import AboutAnimetion from '@/components/AboutAnimetion/AboutAnimetion';
...
const AboutPage = () => {
    return (
        <div className=''>
                ...
                <div className="hero min-h-screen  px-2 lg:px-5 container mx-auto ">
                    <div className="flex justify-between items-center flex-col gap-5 lg:flex-row">
                        <div className='  flex-1  '>
                            <Image src={Asif} className='w-full lg:w-3/4 rounded-full p-2 bg-black  ' width={1000} height={500} alt='My Image'></Image>
                        </div>
                        <div className='w-full lg:w-3/5 text-white'>
                            <div className="flex-1  md:text-left space-y-3">
                                <AboutAnimetion></AboutAnimetion>
                ...
                <div className="hero   px-2 lg:px-5 ">
                    <div className="flex justify-between items-center flex-col-reverse gap-5 lg:flex-row">
                        <div className='w-full lg:w-3/5  '>
                            <div className="flex-1  md:text-left space-y-3">
                                <h1  className="py-2 font-medium text-xl lg:text-3xl ">ICPC 2023 Contest: A Journey into the World of Competitive Programming</h1>
                                <p className='py-2'>
                        ...
                        <div className=' flex-1 flex justify-center items-center'>
                            <Image src={Asificpc} className='w-full lg:w-3/4 rounded-full animate__fadeInLeft ' width={1000} height={500} alt='My Image'></Image>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className=" container mx-auto flex justify-between flex-col md:flex-row items-center lg:items-start  p-3 lg:gap-10">
