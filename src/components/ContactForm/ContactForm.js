            ...
            <form onSubmit={handleSubmit} className='space-y-3 bg-black px-3 lg:px-8 py-3 rounded-lg   lg:py-8 text-white' >
                <div>
                    ...
                    <input
                        ...
                        required
                        className='border-2 text-black bg-white border-black w-full rounded-lg px-2 py-1  Your Name '
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={handleChange}
                        required
                        className='border-2 text-black bg-white border-black w-full rounded-lg px-2 py-1'
                ...
                <div>
                    ...
                    <textarea
                        ...
                        onChange={handleChange}
                        required
                        className='border-2 text-black bg-white border-black w-full rounded-lg px-2 py-1 h-32'
