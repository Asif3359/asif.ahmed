    ...
    return (
        <section className="container mx-auto my-4">
            <div className="first-resume-container">
                <h2 className="text-4xl font-extrabold text-center py-5 my-5">A summary of My Resume</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 ">
                    ...
                    <div className="space-y-5 flex-1">
                        <div className=" flex flex-col lg:flex-row  gap-3 justify-center items-center md:justify-start md:items-start p-5 lg:p-0 text-center  md:text-start ">
                            ...
                            <div>
                                <h2 className="text-2xl font-extrabold mb-3"> Education</h2>
                    ...
                    <div className="space-y-5 flex-1">
                        <div className=" flex flex-col lg:flex-row  gap-3 justify-center items-center md:justify-start md:items-start p-5 lg:p-0 text-center  md:text-start ">
                            ...
                            <div>
                                <h2 className="text-2xl font-extrabold mb-3"> Work Experience</h2>
